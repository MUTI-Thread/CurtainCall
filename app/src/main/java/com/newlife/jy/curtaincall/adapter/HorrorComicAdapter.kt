...
class HorrorComicAdapter(val context: Context, data: List<HorrorComicBean.Contentlist>?)
    : BaseQuickAdapter<HorrorComicBean.Contentlist, BaseViewHolder>(data) {

    init {
        this.mLayoutResId = R.layout.item_horror_comic
    }

    override fun convert(helper: BaseViewHolder, item: HorrorComicBean.Contentlist) {
